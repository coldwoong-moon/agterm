...
//!
//! Usage:
//!   cargo run --example diff_files --features iced-gui <old_file> <new_file> [--unified] [--width <width>]
//!
//! Examples:
//!   cargo run --example diff_files --features iced-gui file1.txt file2.txt
//!   cargo run --example diff_files --features iced-gui old.rs new.rs --unified
//!   cargo run --example diff_files --features iced-gui old.txt new.txt --width 120
//!
...
fn main() {
    ...
    eprintln!("  cargo run --example diff_files --features iced-gui <old_file> <new_file>");
}
